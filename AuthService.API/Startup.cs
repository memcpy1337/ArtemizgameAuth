...
#if !DEBUG
                jwtSettings.AccessTokenSecret = Environment.GetEnvironmentVariable("JWT_ACCESS_TOKEN_SECRET");
                jwtSettings.RefreshTokenSecret = Environment.GetEnvironmentVariable("JWT_REFRESH_TOKEN_SECRET");
#endif
                x.SaveToken = true;
